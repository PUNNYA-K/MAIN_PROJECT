  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: TextTheme(
          titleLarge: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.white, fontFamily: 'Inder'),
          bodyLarge: TextStyle(fontSize: 18, color: Colors.black, fontFamily: 'Inder'),
        ),
      ),
...
class _SignupPageState extends State<SignupPage> {
  ...
  } else if (!RegExp(r'^[a-z][a-z0-9]*@gmail\.com$').hasMatch(value)) {
  ...
  Widget _buildTextField(String label, bool obscureText, TextEditingController controller, String? Function(String?)? validator) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        labelText: label,
        labelStyle: TextStyle(color: Color.fromARGB(255, 0, 0, 0), fontFamily: 'Inder'),
